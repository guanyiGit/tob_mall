          ...
          <div class="w600 c-b">
            <form action="#">
              ...
              <div class="mgt200 t-c">
                <input type="button" :disabled="isDisplay" @click="addDeliveryman()" class="w100 btn btn-primary" value="保存">
  ...
  export default {
    ...
    methods : {
      addDeliveryman : function () {
        ...
        this.isDisplay=true
        console.log(this.deliInstManDto)
        this.$axios({
          async:false,
          method : 'post',
          // headers:{
