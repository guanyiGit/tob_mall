...
import com.shiro.exception.PrincipalIdNullException;
import com.shiro.exception.PrincipalInstanceException;
import com.shiro.exception.SerializationException;
import com.shiro.redis.IRedisManager;
import com.shiro.serializer.ObjectSerializer;
import com.shiro.serializer.RedisSerializer;
import com.shiro.serializer.StringSerializer;
...
public class RedisCache<K, V> implements Cache<K, V> {
    ...
    private String getStringRedisKey(K key) {
        ...
        }else if (key instanceof UserInfo) {
            redisKey = ((UserInfo) key).getAccount();
        }
        else {
