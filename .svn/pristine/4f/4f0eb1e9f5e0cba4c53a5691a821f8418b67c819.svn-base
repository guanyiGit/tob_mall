          ...
          <div class="w600 c-b">
            <form action="#">
              <div class="ovh">
                ...
                <div class="mgl70">
                  <input disabled class="db ww100 h40 lh40 bor-d" type="text" v-if="deliveryMan&&deliveryMan.id" v-model="deliveryMan.id">
              ...
              <div class="ovh mgt20">
                ...
                <div class="mgl70">
                  <input @blur="isPhone" class="db ww100 h40 lh40 bor-d" type="text" v-if="deliveryMan&&deliveryMan.phone_num" v-model="deliveryMan.phone_num">
                  <input class="db ww100 h40 lh40 bor-d" type="text" v-else>
                </div>
              </div>
