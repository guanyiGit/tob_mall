  ...
  <div class="ww100 pdl15 pdr15 pdb130">
    <div class="w1200 c-b mm100 mgt30">
      <div class="ovh pdb10 bor-b-d">
        ...
        <a href="javascript:"class="db fr fs18 cor0" @click="$router.back(-1)">返回</a>
        <!--<router-link href="###" class="db fr fs18 cor0" :to="{name:'buyerGoods'}">返回</router-link>-->
      </div>
      <div class="mgt20 bor-d pdt30 pdb200 pdl50 pdr50">
        <div>
          <p class="fs18 cor0 bgf9 h50 lh50 pdl20 pdr20 btn-a7">基本信息<a href="javacript:void(0)" class="dinb fr fs12 cor0">折叠</a></p>
        ...
        <div>
          <p class="fs18 cor0 bgf9 h50 lh50 pdl20 pdr20 btn-a7">商品属性<a href="javacript:void(0)" class="dinb fr fs12 cor0">折叠</a></p>
