...
//		user.setDeptName(deptMapper.get(user.getDeptId()).getName());
	...
	public List<UserDO> list(Map<String, Object> map) {
		...
		List<OrgInfoDO> list = orgInfoService.findAll(orgId);
	...
	@Override
	public R resetPassword(Integer userId,String oldPassWord, String newPassword) throws Exception {
		UserDO userDO = userMapper.get(userId.longValue());
		...
		if (!password.equals(userDO.getPassword())){
			...
			userMapper.resetPassword(userId.longValue(),newPassword);
			return  R.ok("修改成功");
		}
	}
