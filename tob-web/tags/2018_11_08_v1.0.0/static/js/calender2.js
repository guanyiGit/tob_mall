window.calender = (function(win,doc){
  ...
  C.prototype = {
    ...
    getDateLength : function(year,month){
      //鑾峰彇鏌愪竴鏈堟湁澶氬皯澶�, month涓哄疄闄呮湀浠斤紝涓€鏈堝嵆涓�1
      return new Date(year,month,0).getDate();
    },
    getFirstDay : function(year,month){
      //鑾峰彇鏌愪竴鏈堢涓€澶╂槸鍛ㄥ嚑,month涓哄疄闄呮湀浠斤紝涓€鏈堝嵆涓�1,杩斿洖0鍗充负鍛ㄦ棩
    ...
    create : function(){
      ...
      var private_Day_title=['涓€','浜�','涓�','鍥�','浜�','鍏�','鏃�'];
      //鍐呭
      var html = '<div class="calender-wrap '+ t.s.addClass +'">';
      html +='<div id="calender-header" class="calender-header none-btn "><a id="calender-prev" href="javascript:;">&lt;</a><a id="calender-next" href="javascript:;">&gt;</a>  <span id="calender-year">2016</span>骞�<span id="calender-mon">10</span>鏈�</div>'
      //鏄熸湡
      ...
      if(this.s.button){
        html+='<div class="calender-button"><a href="javascript:;" class="calender-ent">纭畾</a><a href="javascript:;" class="calender-today">浠婂ぉ</a></div>';
      };
    ...
    format : function(da,format){
      ...
      var WeekArr=['鏄熸湡鏃�','鏄熸湡涓€','鏄熸湡浜�','鏄熸湡涓�','鏄熸湡鍥�','鏄熸湡浜�','鏄熸湡鍏�'];
      var o = {
