...
import com.RBAC.dao.OrgInfoDao;
import com.RBAC.dao.UserInfoDao;
import com.RBAC.dao.UserRefRoleDao;
import com.RBAC.dao.UserRefSubDao;
import com.RBAC.domain.*;

import com.RBAC.service.OrgInfoService;
import com.RBAC.service.UserInfoService;
import com.RBAC.vo.UserRefSubVo;
import com.RBAC.vo.UserSelVO;
import com.utils.MD5Utils;
import com.utils.Md5Encode;
import com.utils.R;
...
//		user.setDeptName(deptMapper.get(user.getDeptId()).getName());
	...
	public List<UserDO> list(Map<String, Object> map) {
		...
		List<OrgInfoDO> list = orgInfoService.list(orgId);
	...
	@Override
	public R resetPassword(UserDO userDO, String oldPassWord, String newPassword) throws Exception {
		String password = Md5Encode.getCredentials(userDO.getUsername(), oldPassWord).toString();
		//判断原密码是否正确
		if (!password.equals(userDO.getUsername())){
			return  R.error(501,"原密码不正确");
		}else {
			newPassword = Md5Encode.getCredentials(userDO.getUsername(),newPassword).toString();
			userMapper.resetPassword(userDO.getUserId(),newPassword);
			return  R.ok("修改成功");
		}
	}
...
//	}
	...
	public int save(UserRefSubVo userRefSubVo){
        ...
        user.setOrgId(userRefSubVo.getOrgId());
